$(document).ready(function () {
    ...
    $(document).on('click change', '.chon-khach-hang-radio-btn', function (e){
        ...
        <div class="selected-card">
            ...
            <div class="selected-card-content"><strong>Khách:</strong> ${$('<div>').text(hoten).html()} (${$('<div>').text(dienthoai).html()})</div>
            <a href="#" class="selected-card-close" id="xoa-khach-da-chon"><i class="fas fa-times-circle"></i></a>
        </div>
    `).css('display', 'flex');
    });
    ...
    $(document).on('click change', '.chon-sale-radio-btn', function (e){
        ...
        <div class="selected-card">
            ...
            <div class="selected-card-content"><strong>Sale:</strong> ${$('<div>').text(hoten).html()} (${$('<div>').text(dienthoai).html()})</div>
            <a href="#" class="selected-card-close" id="xoa-sale-da-chon"><i class="fas fa-times-circle"></i></a>
        </div>
    `).css('display', 'flex');
    });
    ...
    $(document).on('click','.btn-hoan-thanh',function (e){
        ...
        var hopDongID = $(this).attr('data-value'),
            loai = $(this).attr('loai');
        if (confirm('Bạn có chắc chắn muốn xác nhận hoàn thành hợp đồng?')) {
            $.ajax({
