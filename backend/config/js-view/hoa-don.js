$(document).ready(function () {
    ...
    function getNganHan(){
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(data) {
                var saveBtn = '<a href="#" class="btn btn-success" id="btn-thanh-toan"><i class="fa fa-money"></i> In QR code</a>',
                    doanhThu = '';
    ...
    function updateTongTien(trLocal = null){
        ...
        $.ajax({
            ...
            type: 'post',
            data: {dienDau: dienDau, dienCuoi: dienCuoi, nuocDau: nuocDau, nuocCuoi: nuocCuoi, hoaDonID: id, thang: $('#thang').val(), nam: $('#nam').val()},
            dataType: 'json',
            success: function(data) {
                if (data.success){
    ...
    $(document).on('change input','.so-dau, .so-cuoi',function (e){
        e.preventDefault();
        tr = $(this).closest('tr');
        console.log('dã thay đổi số điện');
        updateTongTien(tr);
    });
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.soLuong !== 0 && check){
                        saveBtn = '<a href="#" class="btn btn-success" id="btn-thanh-toan"><i class="fa fa-money"></i> In QR code</a>';
                        $('.thongbao').html('');
                    }
                    doanhThu = parseInt(data.doanhThu);
                    $('.btn-save-bill').html(saveBtn);
