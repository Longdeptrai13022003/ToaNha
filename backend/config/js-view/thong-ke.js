$(document).ready(function () {
                ...
                $.each(data.content, function (k, obj){
                    ...
                    for (var i = 0; i < Object.keys(obj).length; i++) {
                        ...
                        if(i === 0){
                            ...
                            htmls += '<td><input type="text" class="form-control text-right thanh_tien" value="'+value+'" name="thanh_tien[]"></td>';
                        }
                    }
    ...
    $(document).on('click','#them-chi-phi',function (e){
        ...
        var htmls = '<tr><td><input type="text" class="form-control" id="ten-chi-phi" name="ten_chi_phi_them[]"></td>' +
            ...
            '<td><input type="text" class="form-control text-right thanh_tien" value="0" name="thanh_tien_them[]"></td>' +
