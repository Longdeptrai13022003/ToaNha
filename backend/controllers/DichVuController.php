...
use backend\models\search\DichVuSearch;
            ...
            foreach ($arr_action as $item) {
                $rules[] = [
                    ...
                    'matchCallback' => function ($rule, $action) {
                        ...
                        return $this->contentAPI->uid == 1 || myAPI::isAccess2('DichVu', $action_name, $this->contentAPI->uid);
                    }
                ];
            }
        }else
...
//                'matchCallback' => myAPI::isAccess2($controller, $item)
                    'matchCallback' => function ($rule, $action) {
                        $action_name =  strtolower(str_replace('action', '', $action->id));
                        return myAPI::isAccess2('DichVu', $action_name);
                    }
                ];
            }
        return [
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new DichVu",
                    'content'=>'<span class="text-success">Create DichVu success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing DichVu model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing DichVu model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
