...
<head>
    <meta charset="utf-8"/>
    <title><?=\common\models\myAPI::TEN_PHAN_MEM?></title>
...
<div class="logo">
    <a href="#" style="font-size: 18pt; text-decoration: none">
        <?=\common\models\myAPI::TEN_PHAN_MEM?>
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <div style="display: flex">
        <a href="#">
            <img src="image/CHpaly.png" alt="" width="200">
        </a>
        <a href="#">
            <img src="image/IOS.png" alt="" width="200">
        </a>
    </div>
...
<div class="copyright">
    <?=date("Y"); ?> HỆ THỐNG ĐƯỢC THIẾT KẾ BỞI <a href="https://andin.io" target="_blank">DDL</a> <sup>™</sup>
</div>
<!-- END LOGIN -->
