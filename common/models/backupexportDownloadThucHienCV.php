...
class backupexportDownloadThucHienCV
{
    public $data;
    public $tieude;
    public $path_file;
    ...
    public $title = 'TAI PHIEU DE NGHI';
    public $subject = 'TAI PHIEU DE NGHI';
    public $description = '';
    public $category = '';
    public $lastModifiedBy = 'MINH HIEN SETE.,CO.LTD';
    public $keywords = '';
    public $sheetTitle = 'TAI PHIEU DE NGHI';
    public $legal = 'TAI PHIEU DE NGHI';
...
//        PHPExcel_Worksheet_PageSetup
        ...
        self::$objPHPExcel->createSheet()->setTitle("TAI PHIEU DE NGHI");
        self::$objPHPExcel->setActiveSheetIndexByName("TAI PHIEU DE NGHI");
    ...
    public function renderBody($activeSheet){
        ...
        $activeSheet->setCellValue("B6", "Kính gửi: ".$data->phongBan->name);
        ...
        $phongBanThucHien = PhongBanThucHienThamDinh::findAll(['phan_loai' => PhongBanThucHienThamDinh::THUC_HIEN]);
...
//        formatExcel::setBorder($activeSheet, "A8:I".($dong-1));
    ...
    public function run()
    {
        ...
        $this->filename = "DE_XUAT_CONG_VIEC_".$this->tieude;
